...
const PriceCard = ({
  ...
  return (
    <div
      className={`relative bg-white rounded-2xl shadow-lg border transition-all duration-500 ease-out transform hover:scale-[1.02] group/card w-full max-w-xs sm:max-w-sm mx-auto overflow-hidden ${
        isBestValue
      ...
      <div className="relative p-4 sm:p-6 z-10">
        ...
        <div className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
          {features.map((feature, featureIndex) => (
            ...
            >
              <div
                className={`flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 rounded-full flex items-center justify-center mr-2 sm:mr-3 transition-all duration-300 ${
                  isBestValue
                    ? "bg-yellow-100"
        ...
        <button
          ...
          className={`w-full py-2.5 sm:py-3 px-4 sm:px-5 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base md:text-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
            isBestValue
